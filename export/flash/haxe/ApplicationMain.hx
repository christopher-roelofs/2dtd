...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/alt_tiles.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/auto_tiles.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/default_alt.txt");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("assets/default_auto.txt");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("assets/default_empty.txt");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("assets/empty_tiles.png");
		types.push (lime.Assets.AssetType.IMAGE);
